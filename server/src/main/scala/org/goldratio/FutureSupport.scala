...
//
//
//import org.goldratio.game.handler.Action
//import org.goldratio.server.{HaltException, AsyncSupport, SwordContext}
//import org.goldratio.server.handler.{ResponseMessage, RequestMessage}
...
//
//abstract class AsyncResult(implicit val request: RequestMessage, implicit val response: ResponseMessage)
//  extends SwordContext {
//
...
//                    } catch {
//                      case e: Throwable =>
//                        HandlerBase.runCallbacks(Failure(e))
